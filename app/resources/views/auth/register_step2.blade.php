        ...
        <div class="flex flex-col md:gap-3">
            <div class="flex flex-col md:flex-row md:gap-4">
                <div class="flex flex-col md:w-1/2">
                    <label for="birth_date" class="mb-1 text-sm text-default/50">Date de naissance</label>
                ...
                <div class="flex flex-col md:w-1/2">
                    <label for="identity_card" class="mb-1 text-sm text-default/50">Carte d'identité (PDF, JPG)</label>
            ...
            <div class="flex flex-col">
                <label for="adresse" class="mb-1 text-sm text-default/50">Localisation</label>
                <input type="text" name="adresse" id="adresse" class="w-full px-3 py-2 text-sm border rounded-md border-input-border bg-input focus:outline-none" placeholder="Entrez votre adresse" required>
                @error('adresse')
                    <div class="text-sm text-red-500">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="flex flex-col">
                <label for="telephone" class="mb-1 text-sm text-default/50">Numéro de téléphone</label>
                <input type="text" name="telephone" id="telephone" class="w-full px-3 py-2 text-sm border rounded-md border-input-border bg-input focus:outline-none" placeholder="Entrez votre numéro de téléphone" required>
                @error('telephone')
                    <div class="text-sm text-red-500">{{ $message }}</div>
                @enderror
            </div>
