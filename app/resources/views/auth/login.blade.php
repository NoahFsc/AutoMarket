...
<div class="flex flex-col mx-8 md:w-1/3 md:mx-auto">
    <div class="w-full text-2xl font-bold md:text-4xl">Connexion</div>
    <form action="{{ route('auth.login') }}" method="POST" class="flex flex-col w-full gap-4 md:gap-7">

        @csrf

        <div>
            <span class="text-default/50">Vous n'avez pas de compte ?</span>
        ...
        <div class="flex flex-col md:gap-3">
            <div class="flex flex-col">
                ...
                <input type="email" name="email" id="email" class="w-full px-3 py-2 text-sm border rounded-md border-input-border bg-input focus:outline-none" placeholder="Entrez un email">
                @error('email')
            ...
            <div class="flex flex-col">
                ...
                <div class="relative">
                    <input type="password" name="password" id="password" class="w-full px-3 py-2 text-sm border rounded-md border-input-border bg-input focus:outline-none" placeholder="Entrez un mot de passe">
