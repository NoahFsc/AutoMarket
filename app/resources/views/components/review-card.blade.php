<div class="p-4 rounded-lg shadow-md bg-input">
    <div class="flex items-center justify-between mb-2">
        ...
        <div class="flex items-center gap-1">
            ...
            <p class="text-sm text-default/50">{{ __('Certified') }}</p>
        </div>
    </div>
    <div class="mb-4">
        <p>{{ $review->comment }}</p>
    ...
    <div class="flex items-center gap-1">
        <img src="{{ $review->user->profile_picture ? asset('storage/' . $review->user->profile_picture) : asset('assets/default_pfp.png') }}" alt="Avatar" class="rounded-full size-8">
