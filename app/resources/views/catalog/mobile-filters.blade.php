    ...
    <div id="content-1" class="overflow-hidden transition-all duration-300 ease-in-out max-h-0">
        ...
        <div class="mb-4">
            ...
            <div class="flex gap-2">
                <input type="text" wire:model.live='postal_code' placeholder="Code postal" class="w-full h-10 mt-1 rounded-md border-input-border bg-background focus:border-primary focus:ring-primary">
            </div>
        </div>
        <div class="mb-4">
            <label for="kilometrage_min" class="text-base opacity-50">Kilométrage</label>
            <div class="flex gap-2">
                <input type="text" wire:model.live='kilometrage_min' placeholder="Min" class="w-full h-10 mt-1 rounded-md border-input-border bg-background focus:border-primary focus:ring-primary">
                <input type="text" wire:model.live='kilometrage_max' placeholder="Max" class="w-full h-10 mt-1 rounded-md border-input-border bg-background focus:border-primary focus:ring-primary">
            </div>
        </div>
        <div class="mb-4">
            <label for="price_min" class="text-base opacity-50">Prix</label>
            <div class="flex gap-2">
                <input type="text" wire:model.live='price_min' placeholder="Min" class="w-full h-10 mt-1 rounded-md border-input-border bg-background focus:border-primary focus:ring-primary">
                <input type="text" wire:model.live='price_max' placeholder="Max" class="w-full h-10 mt-1 rounded-md border-input-border bg-background focus:border-primary focus:ring-primary">
            </div>
        </div>
        <div class="mb-4">
