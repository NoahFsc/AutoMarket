<div class="p-4 border-r w-52 border-opacity-20">
    ...
    <div class="mb-4">
        ...
        <div class="flex gap-2">
            <input type="text" wire:model.live='postal_code' placeholder="Code postal" class="block w-full mt-1 rounded-md border-input-border bg-input h-9 focus:border-primary sm:text-sm">
        </div>
    </div>
    <div class="mb-4">
        <label for="kilometrage_min" class="block text-base opacity-50">Kilométrage</label>
        <div class="flex gap-2">
            <input type="text" wire:model.live='kilometrage_min' placeholder="Min" class="block w-full mt-1 rounded-md border-input-border bg-input h-9 focus:border-primary sm:text-sm">
            <input type="text" wire:model.live='kilometrage_max' placeholder="Max" class="block w-full mt-1 rounded-md border-input-border bg-input h-9 focus:border-primary sm:text-sm">
        </div>
    </div>
    <div class="mb-4">
        <label for="price_min" class="block text-base opacity-50">Prix</label>
        <div class="flex gap-2">
            <input type="text" wire:model.live='price_min' placeholder="Min" class="block w-full mt-1 rounded-md border-input-border bg-input h-9 focus:border-primary sm:text-sm">
            <input type="text" wire:model.live='price_max' placeholder="Max" class="block w-full mt-1 rounded-md border-input-border bg-input h-9 focus:border-primary sm:text-sm">
        </div>
    </div>
    <div>
