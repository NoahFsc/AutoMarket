<div class="flex">
    <div class="p-4 border-r w-52 border-opacity-20">
        ...
        <div class="mb-4">
            ...
            <select wire:model.live="selectedBrand" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm h-9 focus:border-primary-500 focus:ring-primary-500 sm:text-sm">
        ...
        <div class="mb-4">
            ...
            <select wire:model.live="selectedCarModel" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm h-9 focus:border-primary-500 focus:ring-primary-500 sm:text-sm">
        ...
        <div class="mb-4">
            ...
            <div class="flex gap-2">
                <input type="text" wire:model.live='postal_code' placeholder="Code postal" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm h-9 focus:border-primary-500 focus:ring-primary-500 sm:text-sm">
            </div>
        </div>
        <div class="mb-4">
            <label for="kilometrage_min" class="block text-base opacity-50">Kilométrage</label>
            <div class="flex gap-2">
                <input type="text" wire:model.live='kilometrage_min' placeholder="Min" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm h-9 focus:border-primary-500 focus:ring-primary-500 sm:text-sm">
                <input type="text" wire:model.live='kilometrage_max' placeholder="Max" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm h-9 focus:border-primary-500 focus:ring-primary-500 sm:text-sm">
            </div>
        </div>
        <div class="mb-4">
            <label for="price_min" class="block text-base opacity-50">Prix</label>
            <div class="flex gap-2">
                <input type="text" wire:model.live='price_min' placeholder="Min" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm h-9 focus:border-primary-500 focus:ring-primary-500 sm:text-sm">
                <input type="text" wire:model.live='price_max' placeholder="Max" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm h-9 focus:border-primary-500 focus:ring-primary-500 sm:text-sm">
            </div>
        </div>
        <div>
        ...
        <div class="mb-4">
            ...
            <div class="flex gap-2">
                <input type="text" wire:model.live='portes' placeholder="Entrez un nombre" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm h-9 focus:border-primary-500 focus:ring-primary-500 sm:text-sm">
            </div>
        </div>
        <div class="mb-4">
            <label for="sieges" class="block text-base opacity-50">Sièges</label>
            <div class="flex gap-2">
                <input type="text" wire:model.live='sieges' placeholder="Entrez un nombre" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm h-9 focus:border-primary-500 focus:ring-primary-500 sm:text-sm">
            </div>
        </div>
    </div>
    ...
    <div class="flex flex-col w-full max-w-5xl mx-auto">
        <div class="flex items-center justify-between mb-4">
            ...
            <div>
                <button wire:click="toggleSort" class="mr-2 text-gray-700 focus:outline-none">
                ...
                <input type="text" wire:model.live='search' placeholder="Rechercher" class="mt-1 border-gray-300 rounded-md shadow-sm w-96 h-9 focus:border-primary-500 focus:ring-primary-500 sm:text-sm">
            </div>
        </div>
