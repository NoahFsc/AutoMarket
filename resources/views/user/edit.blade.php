            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex flex-col">
                        ...
                        <span class="text-[8px] md:text-sm text-gray-500">Partagez vos données afin de mettre en place des statistiques</span>
                    </div>
                    <div class="flex flex-col">
                        <div class="flex items-center justify-between">
                        ...
                        <span class="text-[8px] md:text-sm text-gray-500">Vous abonner à la newsletter du site</span>
                    </div>
                    <div class="flex flex-col">
                        <div class="flex items-center justify-between">
                        ...
                        <span class="text-[8px] md:text-sm text-gray-500">Activer l’authentification à deux facteurs</span>
                    </div>
                </div>
            ...
            <div class="flex flex-col gap-4">
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex flex-col">
                        ...
                        <span class="text-[8px] md:text-sm text-gray-500">Recevoir des notifications par e-mail</span>
                    </div>
                    <div class="flex flex-col">
                        <div class="flex items-center justify-between">
                        ...
                        <span class="text-[8px] md:text-sm text-gray-500">Recevoir des notifications sonores</span>
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex flex-col">
                        ...
                        <span class="text-[8px] md:text-sm text-gray-500">Afficher votre statut en ligne</span>
                    </div>
                    <div class="flex flex-col">
                        <div class="flex items-center justify-between">
                        ...
                        <span class="text-[8px] md:text-sm text-gray-500">Afficher lorsque vous êtes en train d'écrire</span>
                    </div>
                </div>
                ...
                <div class="flex flex-col">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <select name="archive_duration" id="archive_duration" class="w-1/4 px-3 py-1 text-sm border border-gray-200 rounded-md md:text-base focus:outline-none">
